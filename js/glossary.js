...
window.GLOSSARY = {
    ...
    CPA:         { t:'CPA (전환당 비용)', d:'전환(구매) 1건을 만드는 데 들어간 평균 광고비. 낮을수록 효율적이에요.' },
    CPC:         { t:'CPC (클릭당 비용)', d:'광고를 1번 클릭하게 만드는 데 들어간 평균 광고비. 낮을수록 효율적이에요.' },
    ...
    장바구니당광고비: { t:'장바구니 1건당 광고비', d:'장바구니에 1개 담길 때까지 평균 광고비가 얼마 들었나(광고비 ÷ 장바구니 담기 건수). 낮을수록 효율적이에요.' },
};
...
function _glOpen() {
    ...
    const groups = [
        { h:'📈 효율 지표', keys:['ROAS','CTR','CVR','CPA','CPC','객단가','블렌디드ROAS'] },
        { h:'🛒 퍼널(구매 흐름)', keys:['장바구니율','구매율','장바구니담기','이탈손실','장바구니당광고비'] },
